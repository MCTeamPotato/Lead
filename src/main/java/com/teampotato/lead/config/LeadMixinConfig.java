package com.teampotato.lead.config;
...
public class LeadMixinConfig {
    private final Map<String, Option> options = new HashMap<>();

    private LeadMixinConfig() {
        //this.addMixinRule("a", true);
        //disableIfModPresent("mixin.a", "b");
    }
    ...
    private void readProperties(Properties props) {
        for (Map.Entry<Object, Object> entry : props.entrySet()) {
            ...
            if (option == null) {
                Lead.LOGGER.warn("No configuration key exists with name '{}', ignoring", key);
                continue;
            }
            ...
            if (value.equalsIgnoreCase("true")) {
                ...
                Lead.LOGGER.warn("Invalid value '{}' encountered for configuration key '{}', ignoring", value, key);
                continue;
            }
    ...
    public static LeadMixinConfig load(File file) {
        LeadMixinConfig config = new LeadMixinConfig();
        ...
        try {
            ...
            Lead.LOGGER.warn("Could not write configuration file", e);
        }
    ...
    private void writeConfig(File file, Properties props) throws IOException {
        ...
        try (Writer writer = new FileWriter(file)) {
            writer.write("# This is the configuration file for Lead.\n");
            writer.write("#\n");
